...
public class TemplateState : BasicState
{
	...
	public override void Enter(IStatedObject _parent)
	{
		...
		Camera.main.transform.position = Vector3.forward * -500f;
		...
		PrefabS.CreateFlatPrefabComponentsFromPolygon(tc, Vector3.zero, polygon, Color.white, null, Camera.main);
		DebugDraw.CreateBox(Camera.main, tc, Vector2.zero, 100f, 100f, false);
