...
public class FKevinAndKartA
{
	...
	public static List<IComponent> Assemble(EIC _eic)
	{
		...
		GECharacterC gECharacterC = FKevinA.Assemble(_eic, 2000u, 0f - _eic.data.position.z + 50f);
		GEVehicleC gEVehicleC = FSmallKartA.Assemble(_eic, 2000u, 0f - _eic.data.position.z);
	...
	public static void HandlePropertyChange(EventC _c)
	{
		...
		if (identifier != null)
		{
			...
			int value;
			if (!_003C_003Ef__switch_0024mapA.TryGetValue(identifier, out value))
			{
			}
		}
