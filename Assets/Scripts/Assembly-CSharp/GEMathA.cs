...
public static class GEMathA
{
	public static GETriggerC Assemble(EIC _eic, TriggerData _data)
	{
		...
		GETriggerC gETriggerC = GES.AddTriggerComponent(_eic.camera, _data, TriggerType.MathTrigger, tc);
		...
		gETriggerC.modifierSlots[0] = new ConnectionSlot(ConnectionSlotType.Modifier, 0);
