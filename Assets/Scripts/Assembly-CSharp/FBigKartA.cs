...
public class FBigKartA
{
	...
	public static GEVehicleC Assemble(EIC _eic, uint _colliderGroup, float _sortOffset)
	{
		...
		GESpritePrefabC gESpritePrefabC = SpritePrefabA.Assemble(_eic.data.position.ToVector3(), "BigKart", tags, (ColliderType)12, _colliderGroup, GEState.layer_middle, _sortOffset);
		...
		gEVehicleC.vehicleType = (VehicleType)1;
	...
	public static void HandlePropertyChange(EventC _c)
	{
		...
		if (identifier != null)
		{
			...
			int value;
			if (!_003C_003Ef__switch_0024map6.TryGetValue(identifier, out value))
			{
			}
		}
