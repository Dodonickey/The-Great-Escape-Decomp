...
public static class FLargeVehicleA
{
	public static GEVehicleC Assemble(Vector3 _pos, uint _colliderGroup, PlayerState _playerState, uint _colliderLayer)
	{
		...
		GESpritePrefabC gESpritePrefabC = SpritePrefabA.Assemble(_pos, "BigKart", tags, (ColliderType)12, _colliderGroup, GEState.layer_middle, 0f);
